export const GAS_TOKEN_NAME = 'MON'
export const DEX_NAME = ' Yowie'
export const ASSET_URL = 'https://eerqjuoolke6ijuj.public.blob.vercel-storage.com/'
export const EXPLORER_URL = 'https://monadscan.com/'
export const DEX_URL = 'https://yowie.fi/'
export const V3_INFO_URL = 'https://info.yowie.fi/'
export const DOCS_URL = 'https://docs.google.com/forms/d/e/1FAIpQLSfElCtOskMxByCPUbR17bp835YX1PgB4WX2alog0NvbneznaA/viewform?usp=header'
export const TWITTER_URL = 'https://twitter.com/yowie_fi'
...
export const accent1_dark = '#836ef9'
export const accent2_dark = '#5a4bd9'
export const navBackground_dark = '#1A1A1D'

export const FACTORY_ADDRESS = '0xFefdf9234E29Dc435D5D04ebe425a0c70d2a1824'
